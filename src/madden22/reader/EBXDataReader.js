const EBXField = require('madden-file-tools/filetypes/EBX/EBXField');
const utilService = require('madden-file-tools/services/utilService');
const EBXFieldTypes = require('madden-file-tools/filetypes/EBX/EBXFieldTypes');
const EBXDataObject = require('madden-file-tools/filetypes/EBX/EBXDataObject');
const EBXData = require('madden-file-tools/filetypes/EBX/EBXData');
const EBXPointer = require('madden-file-tools/filetypes/EBX/EBXPointer');
const EBXResourceReference = require('madden-file-tools/filetypes/EBX/EBXResourceReference');
...
class EBXDataReader {
    ...
    readEbxData(ebxFile) {
        ...
        ebxFile.ebx.efix.dataOffsets.forEach((offset, index) => {
            ...
            if (!type) {
                console.warn(`Type from GUID {${typeInfoGuid}} not found. EBX file: ${ebxFile.name}`);
            }
